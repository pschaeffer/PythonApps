  ...
  for row in range(glbRowMin, glbRowMax+1):
    ...
    for value1 in range(glbValueMin, glbValueMax+1):
      ...
      for value2 in range(value1+1, glbValueMax+1):
        ...
        removeAllowsFromListPair(tempCells, allowList, colIndex1, colIndex2) 
        removeOtherValuesFromList(cells1, allowList)
  # Scan all of the columns looking for a column where the 
  # current value has just two (and only two) possible
  # locations.
  for col in range(glbColMin, glbColMax+1):
    ...
    for value1 in range(glbValueMin, glbValueMax+1):
      ...
      for value2 in range(value1+1, glbValueMax+1):
        ...
        allowList = [value1, value2]
        removeAllowsFromListPair(tempCells, allowList, rowIndex1, rowIndex2) 
        removeOtherValuesFromList(cells1, allowList)
  # Scan all of the boxes looking for a box where the 
  # current value has just two (and only two) possible
  # location.
  for box in range(glbBoxMin, glbBoxMax+1):
    ...
    for value1 in range(glbValueMin, glbValueMax+1):
      ...
      for value2 in range(value1+1, glbValueMax+1):
        ...
        allowList = [value1, value2]
        removeAllowsFromListPair(tempCells, allowList, index1, index2) 
        removeOtherValuesFromList(cells1, allowList)
        ...
        if rowIndex1 == rowIndex2:
          ...
          removeAllowsFromListPair(tempCellsRow, allowList, colIndex1, colIndex2) 
        ...
        if colIndex1 == colIndex2:
          ...
          removeAllowsFromListPair(tempCellsCol, allowList, rowIndex1, rowIndex2) 
          ...
          for index4 in range(0, allowedListMergeLen):
            ...
            for index5 in range(index4+1, allowedListMergeLen):
              ...
              for index6 in range(index5+1, allowedListMergeLen):
                ...
                removeAllowsFromListTriple(tempCells, tripleList, index1-1, index2-1, index3-1)
                removeOtherValuesFromList(cellsList, tripleList)
                tripleCount += 1  
  ...
  for row in range(glbRowMin, glbRowMax+1):
    ...
    while index1 < glbColMax:
      ...
      while index2 < glbColMax:
        ...
        removeAllowsFromListPair(tempCells, allowList, index1-1, index2-1)  
    ...
    while index1 < glbColMax:
      ...
      while index2 < glbColMax:
        ...
        while index3 < glbColMax:
          ...
          #  continue
          # Remove all of the allowed values from the rest of the row
          removeAllowsFromListTriple(tempCells, allowedListMerge, index1-1, index2-1, index3-1)
          tripleCount += 1
      ...
      while index2 < glbBoxMax:
        ...
        while index3 < glbBoxMax:
          ...
          if rowIndex1 == rowIndex2 and \
            ...
            tripleCount += 1
            tempCellsRow = copyBoard.getRow(rowIndex1+1)
            removeAllowsFromListTriple(tempCellsRow, allowedListMerge, colIndex1, colIndex2, colIndex3) 
          ...
          if colIndex1 == colIndex2 and \
            ...
            tripleCount += 1
            tempCellsCol = copyBoard.getCol(colIndex1+1)
            removeAllowsFromListTriple(tempCellsCol, allowedListMerge, rowIndex1, rowIndex2, rowIndex3)  
  # Return the final triple count 
  return tripleCount
    ...
    for box in range(glbBoxMin, glbBoxMax+1):
      ...
      if count == 3:
        ...
        if rowIndex1 == rowIndex2 and \
          ...
          pairTripleCount += 1
          tempCellsRow = copyBoard.getRow(rowIndex1+1)
          removeAllowsFromListTriple(tempCellsRow, allowList, colIndex1, colIndex2, colIndex3) 
        # We can now check if the column positions match. If this
        # is true, then the rest of the column can be adjusted to 
        # remove the allowed values.
        if colIndex1 == colIndex2 and \
          ...
          pairTripleCount += 1
          tempCellsCol = copyBoard.getCol(colIndex1+1)
          removeAllowsFromListTriple(tempCellsCol, allowList, rowIndex1, rowIndex2, rowIndex3) 
  # Return the final pair and/or triple count 
  return pairTripleCount
...
# and the cell is not part of the pair.
  ...
  for allowValue in allowList:
    ...
    while index3 < curCellsLen:
      ...
      if (index3-1) == index1 or \
         (index3-1) == index2:
        continue
      removeAllowValue(tempCell3, allowValue)  

# Remove a set of allow values from a list of cells.
# This is only done if the cell has the allow value
# and the cell is not part of the triple.
  ...
  for allowValue in allowList:
    ...
    while indexCellList < curCellsLen:
      ...
      if (indexCellList-1) == index1 or \
        ...
        continue
      removeAllowValue(tempCellFromList, allowValue) 
  ...
  for cell in curCells:
    ...
    for allowValue in dcAllowList:
      if allowValue in allowedList:
        continue
      removeAllowValue(cell, allowValue)  
...
def trySolve(winRoot, mainBoard, interactive):
  ...
  while True:
    ...
    filledIn = mainBoard.getFilledIn()
    ...
    if iterationCount > 200:
      break
  # Display the final state of the board if need be
  # if interactive:
...
def main():  
  ...
  for boardNumber in range(1, 19):
    ...
    eval(evalStr)
    solved = trySolve(root, mainBoard, interactive)
